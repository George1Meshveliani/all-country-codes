...
class LanguageCodes {
    ...
    {
        return LanguageCodeCollection::getAll();
    }
    ...
    {
        return LanguageCodeCollection::getIt($languageCode) ?: false;
    }
    ...
    {
        return array_search($languageName, LanguageCodeCollection::getAll(), true);
    }
}
